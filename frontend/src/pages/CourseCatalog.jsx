    ...
    <div className="flex-1 bg-[#fcfcfd] min-h-screen pb-20">
      ...
      <div className="pt-12 pb-12 px-8 bg-gradient-to-br from-indigo-50/50 to-white border-b border-border-default">
        <div className="max-w-5xl mx-auto flex flex-col">
          <Link to="/study-prep-center" className="inline-flex items-center gap-2 text-sm text-indigo-600 hover:text-indigo-800 mb-8 font-medium transition-colors bg-white/50 px-4 py-2 rounded-full border border-indigo-100 w-fit hover:shadow-sm">
            <ArrowLeft className="w-4 h-4" />
            Back to Study & Prep Center
          </Link>
          ...
          <p className="text-lg text-text-muted max-w-2xl mb-8">
            Master technical skills with interactive courses. Complete structured chapters to level up your interview readiness.
          </p>
              ...
              <div key={course.course_id} className="group bg-white border border-border-default rounded-2xl overflow-hidden hover:shadow-lg hover:border-indigo-200 transition-all duration-300 flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-border-default">
                    ...
                    <Link 
                      to={`/study-prep-center/${course.course_id}`}
